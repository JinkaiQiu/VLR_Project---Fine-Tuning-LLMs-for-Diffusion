...
def generate_text_with_gumbel_softmax(model, tokenizer, embed, temperature=1.0, entry_length=67, device='cuda', stop_token="<|endoftext|>"):
    model.eval()
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(current_directory, "coco_train")
